...
return [
    ...
    'supportedLocales' => [
        'uz'           => ['name' => 'O’zb',   'script' => 'Cyrl', 'native' => 'Ўзб ', 'regional' => 'uz_UZ'],
        'oz'           => ['name' => 'O’zb',   'script' => 'Latn', 'native' => 'O’zb', 'regional' => 'uz_UZ'],
...
//        'es'          => ['name' => 'Spanish',                'script' => 'Latn', 'native' => 'español', 'regional' => 'es_ES'],
    ...
    // the `/management` would be redirected to `/de/management`.
    //
    ...
    // For example, if `en` is default locale, then `/en/management` and `/management`
    // would be identical.
    //
    ...
    // For example, `/en/management` would be redirected to `/management`.
