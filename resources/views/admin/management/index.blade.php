...
@section('title', 'Бошқарма ҳақида')

@section('content_header')
    <h4>Бошқарма ҳақида</h4>
@stop
...
@section('content')
    <div class="card card-outline card-info">
        <div class="card-header">
            <h3 class="card-title">
                <a href="{{ route('management.create') }}" class="btn btn-primary btn-sm float-right"><span
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    <td>{{ $i++ }}</td>
                    <td>{!!html_entity_decode($item->name['uz'])??""!!}</td>
                    <td>
                        <a href="{{ route('management.edit',  $item->id) }}" class="btn btn-info btn-sm float-left"> <span
