...
@section('content')
    <div class="card card-outline card-info">
        <div class="card-header">
            <h3 class="card-title">
                <a href="{{ route('videos.create') }}" class="btn btn-primary btn-sm float-right"><span
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $item->title['uz'] }}</td>
                    <td style="width: 120px;">{{ $item->video }}</td>
                    <td>
                        <a href="{{ route('videos.edit',  $item->id) }}" class="btn btn-info btn-sm float-left"> <span
