...
@section('content')
    <div class="card card-outline card-info">
        <div class="card-header">
            <h3 class="card-title">
                <a href="{{ route('laws.create') }}" class="btn btn-primary btn-sm float-right"><span
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('laws.edit',  $item->id) }}" class="btn btn-info btn-sm float-left"> <span
                                class="fas fa-fw fa-pencil-alt"></span>
                        </a>
                        <form action="{{ route('laws.destroy',  $item->id) }}" method="post"
